...
(function() {
  var Conf, RedisStore, app, category_controller, coffee, cron, ensureAuthenticated, everyauth, express, helper, helpers, package_controller, packages, port, util, winston;
