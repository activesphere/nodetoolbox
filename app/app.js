...
(function() {
  var Conf, RedisStore, app, background, category_controller, ensureAuthenticated, everyauth, express, fs, helper, helpers, logger, package_controller, packages, port, util;
